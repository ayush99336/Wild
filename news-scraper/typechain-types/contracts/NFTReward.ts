...
export interface NFTRewardInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
  ...
  encodeFunctionData(
    ...
    values: [AddressLike, string, string, string, BytesLike, string]
  ): string;
...
export interface NFTReward extends BaseContract {
  connect(runner?: ContractRunner | null): NFTReward;
  waitForDeployment(): Promise<this>;

  interface: NFTRewardInterface;
  ...
  filters: {
    ...
    "RewardMinted(address,uint256,string,string,bytes32,string)": TypedContractEvent<
      RewardMintedEvent.InputTuple,
      RewardMintedEvent.OutputTuple,
      RewardMintedEvent.OutputObject
    >;
